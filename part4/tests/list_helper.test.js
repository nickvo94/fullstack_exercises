...
describe('most blogs', () => {
  test.only('multiple blogs', () => {
    const result = listHelper.getMostBlogs(blogs)
    expect(result).toEqual({ author: 'Robert C. Martin', blogs: 3 })
  })

  test.only('1 blogs', () => {
    const result = listHelper.getMostBlogs([blogs[0]])
...
describe('most likes', () => {
  ...
  test.only('1 blogs', () => {
    const result = listHelper.getMostLikes([blogs[0]])
